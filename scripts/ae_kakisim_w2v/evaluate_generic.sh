#!/bin/bash
#SBATCH --job-name=ae_kakisim_w2v_generic
...
case $SCENARIO in
    1)
        MODEL_NAME="ae_kakisim_w2v_BCD"
        TRAIN_DATASET="generic-OurAirports.csv"
        ;;
    2)
        MODEL_NAME="ae_kakisim_w2v_ACD"
        TRAIN_DATASET="generic-sakila.csv"
        ;;
    3)
        MODEL_NAME="ae_kakisim_w2v_ABD"
        TRAIN_DATASET="generic-AdventureWorks.csv"
        ;;
    4)
        MODEL_NAME="ae_kakisim_w2v_ABC"
