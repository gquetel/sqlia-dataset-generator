#!/usr/bin/env python3
"""
Standalone script to extract dictionary files from the sakila MySQL database.

This script connects to the sakila database, discovers all tables and columns,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract dictionary files from sakila MySQL database",
